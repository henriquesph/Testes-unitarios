...
namespace ContaTeste.Mock
{
    ...
    public class ContaTeste
    {
        ...
        public void testSolicitarEmprestimo()
        {
            ...
            mock.Setup(x => x.ValidarCredito(It.IsAny<string>(), It.Is<decimal>(i => i <= 5000))).Returns(true); // it.any - aceita qualquer valor do tipo genérico passado e passa condição por Lambda
